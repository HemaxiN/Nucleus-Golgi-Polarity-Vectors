...
* The implementation of the CNN for nuclei and Golgi detection is available [here]().
* The implementation of the GNN for nucleus-Golgi link prediction is available [here]().
